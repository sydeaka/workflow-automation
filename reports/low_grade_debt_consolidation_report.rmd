...
varimp_desc = merge(varimp, dsum[,c('field_name', 'Description')], by.x='variable', by.y='field_name', all.x=T)
varimp_desc = varimp_desc[order(varimp_desc$percentage, decreasing=T),]
rownames(varimp_desc) = NULL

colnames(dsum) = c('Data Types', 'Missing Data (N)', 'Missing Data (%)', 'Description')
...
Time stamp of last report run: `r Sys.time()`
