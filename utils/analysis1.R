...
## Container to hold objects to be saved for reporting
saved_objects = list()
...
mod_aml = h2o.automl(x=pred_names, y=outcome, training_frame=h2o_train, leaderboard_frame=h2o_valid, 
           max_runtime_secs=run_time, exclude_algos='GLM', balance_classes=T)
