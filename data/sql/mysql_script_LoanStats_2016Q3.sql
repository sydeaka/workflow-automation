SET GLOBAL local_infile=1;
    USE lending;
DROP TABLE IF EXISTS LoanStats_2016Q3;
CREATE TABLE LoanStats_2016Q3
(id int, 
member_id int, 
loan_amnt int, 
funded_amnt int, 
...
total_rec_late_fee decimal(4,2), 
recoveries decimal(6,2), 
collection_recovery_fee decimal(5,2), 
...
annual_inc_joint decimal(2,2), 
dti_joint decimal(2,2), 
verification_status_joint varchar(0), 
acc_now_delinq int, 
tot_coll_amt int, 
tot_cur_bal int, 
open_acc_6m int, 
...
orig_projected_additional_accrued_interest decimal(5,2), 
hardship_payoff_balance_amount decimal(6,2), 
hardship_last_payment_amount decimal(5,2), 
disbursement_method varchar(4), 
debt_settlement_flag varchar(1), 
debt_settlement_flag_date varchar(8), 
settlement_status varchar(8), 
settlement_date varchar(8), 
settlement_amount decimal(6,2), 
settlement_percentage decimal(4,2), 
settlement_term int);

LOAD DATA LOCAL INFILE 'data/downloads/LoanStats_2016Q3.csv'
    INTO TABLE LoanStats_2016Q3 
