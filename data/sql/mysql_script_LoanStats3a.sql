DROP TABLE lending.LoanStats2018Q2;
CREATE TABLE lending.LoanStats2018Q2
...
out_prncp decimal(5,3), 
out_prncp_inv decimal(5,3), 
total_pymnt decimal(5,3), 
total_pymnt_inv decimal(5,3), 
total_rec_prncp decimal(5,3), 
total_rec_int decimal(4,3), 
total_rec_late_fee decimal(3,3), 
recoveries decimal(1,3), 
collection_recovery_fee decimal(1,3), 
last_pymnt_d varchar(8), 
last_pymnt_amnt decimal(5,3), 
...
annual_inc_joint decimal(7,3), 
dti_joint decimal(2,3), 
...
pct_tl_nvr_dlq decimal(3,3), 
percent_bc_gt_75 decimal(3,3), 
...
sec_app_revol_util decimal(3,3), 
