SET GLOBAL local_infile=1;
    USE lending;
DROP TABLE IF EXISTS LoanStats_2016Q2;
CREATE TABLE LoanStats_2016Q2
(id varchar(48), 
member_id int, 
loan_amnt int, 
funded_amnt int, 
funded_amnt_inv decimal(7,2), 
term varchar(10), 
int_rate varchar(6), 
...
total_rec_late_fee decimal(6,2), 
...
hardship_start_date varchar(6), 
hardship_end_date varchar(6), 
payment_plan_start_date varchar(6), 
hardship_length int, 
hardship_dpd int, 
...
debt_settlement_flag_date varchar(6), 
...
LOAD DATA LOCAL INFILE 'data/downloads/LoanStats_2016Q2.csv'
    INTO TABLE LoanStats_2016Q2 
